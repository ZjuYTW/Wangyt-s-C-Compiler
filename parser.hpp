...
private:
    ...
    void parserInit();//☑️
    void parse(root_Node*);//☑️
    void printCode();
    void parseFunc(func_Node*);//☑️
    ...
    //*******************************************STAT*******************************************
    //Select_Stat
    void parseIfExp(exp_Node*,stat_Node*);//☑️
    void parseIfElseExp(exp_Node*, stat_Node*, stat_Node*);//☑️
    void parseSwitchExp(exp_Node*, stat_Node*);//☑️,空着
    //Iter_Stat
    void parseWhileExp(exp_Node*, stat_Node*);//☑️
    void parseDoWhileExp(stat_Node*, exp_Node*);//☑️
    void parseFor1Exp(stat_Node* exp_stat1, stat_Node* exp_stat2, stat_Node* stat);//☑️
    void parseFor2Exp(stat_Node* exp_stat1, stat_Node* exp_stat2, exp_Node* exp, stat_Node* stat);//☑️
    void parseFor3Exp(declaration_Node* decl1, stat_Node* stat1, stat_Node* stat);//☑️
    void parseFor4Exp(declaration_Node* decl1, stat_Node* stat1, exp_Node* exp, stat_Node *stat);//☑️
    //Jump_stat
    void parseBreak(stat_Node*);//☑️
    void parseGoto(stat_Node*);//☑️，空着
    void parseContinue(stat_Node*);//☑️，空着
    void parseReturn1(stat_Node*);//☑️
    void parseReturn2(exp_Node *);//☑️
    //Stat
    void parseStat(stat_Node*);//☑️
    void parseLabelStat(stat_Node*);//☑️，空着
    void parseCompoundStat(stat_Node*);//☑️
    void parseExpStat(stat_Node*);//☑️
    void parseSelectStat(stat_Node*);//☑️
    void parseIterStat(stat_Node*);//☑️
    void parseJumpStat(stat_Node*);//☑️
     //*******************************************Declaration***************************************
