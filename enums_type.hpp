...
enum decl_arr_kind {arr_C_exp,arr_NA};
...
enum exp_kind {PRIM,POST,ASSIG,Logcial_OR,Logcial_AND,IOR,XOR,AND,EQUAL,RELAT,SHIFT,ADD,MUL,UNARY,ARUG,CONST_EXP,CON,exp_NA};
